...
\bibitem{diaconis-computer-1983} P.~Diaconis, and B.~Efron,
  ``Computer-Intensive Methods in Statistics,'' Scientific American,
  V. {\bf 248}, 1983.
  \bibitem{Waugh.thesis} S.~Waugh,``Extending and Benchmark Cascade-Correlation", Thesis, 1997.
  \bibitem{Mayukh} H.~Mayukh, ``Age of Abalones using Physical Characteristics: A Classification Problem", ECE 539 Fall 2010 Project Report, Department of Electrical and Computer Engineering University of Wisconsin-Madison, 2010.
\end{thebibliography}
\end{document}
